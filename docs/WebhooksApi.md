...
<a name="Get-DynamicWebhooksForApp"></a>
...
<a name="Invoke-RefreshWebhooks"></a>
...
<a name="Register-DynamicWebhooks"></a>
...
"jira:issue_created"$WebhookDetails = Initialize-WebhookDetails -JqlFilter "MyJqlFilter" -FieldIdsFilter "MyFieldIdsFilter" -IssuePropertyKeysFilter "MyIssuePropertyKeysFilter" -Events "jira:issue_created"
$WebhookRegistrationDetails = Initialize-WebhookRegistrationDetails -Webhooks $WebhookDetails -Url "MyUrl" # WebhookRegistrationDetails | 
