...
<a name="Get-IssuePickerResource"></a>
...
$IssuesAndJQLQueries = Initialize-IssuesAndJQLQueries -Jqls "MyJqls" -IssueIds 0 # IssuesAndJQLQueries | 
...
<a name="Search-ForIssuesUsingJql"></a>
...
<a name="Search-ForIssuesUsingJqlPost"></a>
...
$SearchRequestBean = Initialize-SearchRequestBean -Jql "MyJql" -StartAt 0 -MaxResults 0 -Fields "MyFields" -ValidateQuery "strict" -Expand "MyExpand" -Properties "MyProperties" -FieldsByKeys $false # SearchRequestBean | A JSON object containing the search request.
