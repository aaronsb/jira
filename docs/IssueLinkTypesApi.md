...
$IssueLinkType = Initialize-IssueLinkType -Id "MyId" -Name "MyName" -Inward "MyInward" -Outward "MyOutward" -Self "MySelf" # IssueLinkType | 
...
<a name="Invoke-DeleteIssueLinkType"></a>
