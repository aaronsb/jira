...
# Add comment
try {
    $Result = Add-Comment -IssueIdOrKey $IssueIdOrKey -RequestBody $RequestBody -Expand $Expand
} catch {
...
# Update comment
try {
    $Result = Update-Comment -IssueIdOrKey $IssueIdOrKey -Id $Id -RequestBody $RequestBody -NotifyUsers $NotifyUsers -OverrideEditableFlag $OverrideEditableFlag -Expand $Expand
} catch {
