...
<a name="Find-BulkAssignableUsers"></a>
...
# Find user keys by query
try {
    $Result = Find-UserKeysByQuery -Query $Query -StartAt $StartAt -MaxResults $MaxResults
} catch {
...
<a name="Find-UsersWithAllPermissions"></a>
...
<a name="Find-UsersWithBrowsePermission"></a>
