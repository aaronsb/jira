...
function Add-Comment {
    ...
    Process {
        ...
        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling addComment."
        }
...
function Update-Comment {
    ...
    Process {
        ...
        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling updateComment."
        }
