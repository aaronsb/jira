...
function New-OrUpdateRemoteIssueLink {
    ...
    Process {
        ...
        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling createOrUpdateRemoteIssueLink."
        }
...
function Update-RemoteIssueLink {
    ...
    Process {
        ...
        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling updateRemoteIssueLink."
        }
