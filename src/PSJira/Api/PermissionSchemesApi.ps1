...
function New-PermissionScheme {
    ...
    Process {
        ...
        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling createPermissionScheme."
        }
...
function Update-PermissionScheme {
    ...
    Process {
        ...
        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling updatePermissionScheme."
        }
