...
function New-Issue {
    ...
    Process {
        ...
        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling createIssue."
        }
...
function New-Issues {
    ...
    Process {
        ...
        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling createIssues."
        }
...
function Invoke-DoTransition {
    ...
    Process {
        ...
        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling doTransition."
        }
...
function Edit-Issue {
    ...
    Process {
        ...
        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling editIssue."
        }
...
function Invoke-Notify {
    ...
    Process {
        ...
        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling notify."
        }
