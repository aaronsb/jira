...
function New-WorkflowTransitionProperty {
    ...
    Process {
        ...
        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling createWorkflowTransitionProperty."
        }
...
function Update-WorkflowTransitionProperty {
    ...
    Process {
        ...
        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling updateWorkflowTransitionProperty."
        }
