...
ComponentWithIssueCountLead<PSCustomObject>
#>

function Initialize-ComponentWithIssueCountLead {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => ComponentWithIssueCountLead' | Write-Debug
...
Convert from JSON to ComponentWithIssueCountLead<PSCustomObject>
...
ComponentWithIssueCountLead<PSCustomObject>
#>
function ConvertFrom-JsonToComponentWithIssueCountLead {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => ComponentWithIssueCountLead' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ComponentWithIssueCountLead
