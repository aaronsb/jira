...
ScreenSchemeScreens<PSCustomObject>
#>

function Initialize-ScreenSchemeScreens {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => ScreenSchemeScreens' | Write-Debug
...
Convert from JSON to ScreenSchemeScreens<PSCustomObject>
...
ScreenSchemeScreens<PSCustomObject>
#>
function ConvertFrom-JsonToScreenSchemeScreens {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => ScreenSchemeScreens' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ScreenSchemeScreens
