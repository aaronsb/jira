...
function ConvertFrom-JsonToDashboard {
    ...
    Process {
        ...
        $AllProperties = ("description", "id", "isFavourite", "name", "owner", "popularity", "rank", "self", "sharePermissions", "editPermissions", "automaticRefreshMs", "view", "isWritable", "systemDashboard")
