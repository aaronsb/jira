...
JiraExpressionsComplexityBeanExpensiveOperations<PSCustomObject>
#>

function Initialize-JiraExpressionsComplexityBeanExpensiveOperations {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => JiraExpressionsComplexityBeanExpensiveOperations' | Write-Debug
...
Convert from JSON to JiraExpressionsComplexityBeanExpensiveOperations<PSCustomObject>
...
JiraExpressionsComplexityBeanExpensiveOperations<PSCustomObject>
#>
function ConvertFrom-JsonToJiraExpressionsComplexityBeanExpensiveOperations {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => JiraExpressionsComplexityBeanExpensiveOperations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JiraExpressionsComplexityBeanExpensiveOperations
