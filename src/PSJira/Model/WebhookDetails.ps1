...
function ConvertFrom-JsonToWebhookDetails {
    ...
    Process {
        ...
        $AllProperties = ("jqlFilter", "fieldIdsFilter", "issuePropertyKeysFilter", "events")
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'jqlFilter' missing."
        }
