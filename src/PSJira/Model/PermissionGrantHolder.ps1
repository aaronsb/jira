...
PermissionGrantHolder<PSCustomObject>
#>

function Initialize-PermissionGrantHolder {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => PermissionGrantHolder' | Write-Debug
...
Convert from JSON to PermissionGrantHolder<PSCustomObject>
...
PermissionGrantHolder<PSCustomObject>
#>
function ConvertFrom-JsonToPermissionGrantHolder {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PermissionGrantHolder' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PermissionGrantHolder
