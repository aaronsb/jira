...
FieldDetailsSchema<PSCustomObject>
#>

function Initialize-FieldDetailsSchema {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => FieldDetailsSchema' | Write-Debug
...
Convert from JSON to FieldDetailsSchema<PSCustomObject>
...
FieldDetailsSchema<PSCustomObject>
#>
function ConvertFrom-JsonToFieldDetailsSchema {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => FieldDetailsSchema' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FieldDetailsSchema
