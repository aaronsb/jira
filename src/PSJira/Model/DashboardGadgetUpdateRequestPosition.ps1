...
DashboardGadgetUpdateRequestPosition<PSCustomObject>
#>

function Initialize-DashboardGadgetUpdateRequestPosition {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => DashboardGadgetUpdateRequestPosition' | Write-Debug
...
Convert from JSON to DashboardGadgetUpdateRequestPosition<PSCustomObject>
...
DashboardGadgetUpdateRequestPosition<PSCustomObject>
#>
function ConvertFrom-JsonToDashboardGadgetUpdateRequestPosition {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => DashboardGadgetUpdateRequestPosition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DashboardGadgetUpdateRequestPosition
