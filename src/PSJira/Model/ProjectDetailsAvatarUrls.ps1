...
ProjectDetailsAvatarUrls<PSCustomObject>
#>

function Initialize-ProjectDetailsAvatarUrls {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => ProjectDetailsAvatarUrls' | Write-Debug
...
Convert from JSON to ProjectDetailsAvatarUrls<PSCustomObject>
...
ProjectDetailsAvatarUrls<PSCustomObject>
#>
function ConvertFrom-JsonToProjectDetailsAvatarUrls {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => ProjectDetailsAvatarUrls' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectDetailsAvatarUrls
