...
function ConvertFrom-JsonToIssuesJqlMetaDataBean {
    ...
    Process {
        ...
        $AllProperties = ("startAt", "maxResults", "count", "totalCount", "validationWarnings")
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'startAt' missing."
        }
