...
EventNotificationField<PSCustomObject>
#>

function Initialize-EventNotificationField {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => EventNotificationField' | Write-Debug
...
Convert from JSON to EventNotificationField<PSCustomObject>
...
EventNotificationField<PSCustomObject>
#>
function ConvertFrom-JsonToEventNotificationField {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => EventNotificationField' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EventNotificationField
