...
WorkflowSchemeAssociationsWorkflowScheme<PSCustomObject>
#>

function Initialize-WorkflowSchemeAssociationsWorkflowScheme {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => WorkflowSchemeAssociationsWorkflowScheme' | Write-Debug
...
Convert from JSON to WorkflowSchemeAssociationsWorkflowScheme<PSCustomObject>
...
WorkflowSchemeAssociationsWorkflowScheme<PSCustomObject>
#>
function ConvertFrom-JsonToWorkflowSchemeAssociationsWorkflowScheme {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => WorkflowSchemeAssociationsWorkflowScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WorkflowSchemeAssociationsWorkflowScheme
        $AllProperties = ("id", "name", "description", "defaultWorkflow", "issueTypeMappings", "originalDefaultWorkflow", "originalIssueTypeMappings", "draft", "lastModifiedUser", "lastModified", "self", "updateDraftIfNeeded", "issueTypes")
