...
EventNotificationUser<PSCustomObject>
#>

function Initialize-EventNotificationUser {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => EventNotificationUser' | Write-Debug
...
Convert from JSON to EventNotificationUser<PSCustomObject>
...
EventNotificationUser<PSCustomObject>
#>
function ConvertFrom-JsonToEventNotificationUser {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => EventNotificationUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EventNotificationUser
