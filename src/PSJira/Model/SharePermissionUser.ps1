...
SharePermissionUser<PSCustomObject>
#>

function Initialize-SharePermissionUser {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => SharePermissionUser' | Write-Debug
...
Convert from JSON to SharePermissionUser<PSCustomObject>
...
SharePermissionUser<PSCustomObject>
#>
function ConvertFrom-JsonToSharePermissionUser {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => SharePermissionUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SharePermissionUser
        $AllProperties = ("key", "self", "name", "displayName", "active", "accountId", "avatarUrls")
