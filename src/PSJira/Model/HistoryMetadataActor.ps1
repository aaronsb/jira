...
HistoryMetadataActor<PSCustomObject>
#>

function Initialize-HistoryMetadataActor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => HistoryMetadataActor' | Write-Debug
...
Convert from JSON to HistoryMetadataActor<PSCustomObject>
...
HistoryMetadataActor<PSCustomObject>
#>
function ConvertFrom-JsonToHistoryMetadataActor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => HistoryMetadataActor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in HistoryMetadataActor
