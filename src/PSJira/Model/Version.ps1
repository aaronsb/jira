...
function ConvertFrom-JsonToVersion {
    ...
    Process {
        ...
        $AllProperties = ("expand", "self", "id", "description", "name", "archived", "released", "startDate", "releaseDate", "overdue", "userStartDate", "userReleaseDate", "project", "projectId", "moveUnfixedIssuesTo", "operations", "issuesStatusForFixVersion")
