...
RemoteIssueLinkObject<PSCustomObject>
#>

function Initialize-RemoteIssueLinkObject {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => RemoteIssueLinkObject' | Write-Debug
...
Convert from JSON to RemoteIssueLinkObject<PSCustomObject>
...
RemoteIssueLinkObject<PSCustomObject>
#>
function ConvertFrom-JsonToRemoteIssueLinkObject {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => RemoteIssueLinkObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RemoteIssueLinkObject
