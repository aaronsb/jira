...
SharePermissionProject<PSCustomObject>
#>

function Initialize-SharePermissionProject {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => SharePermissionProject' | Write-Debug
...
Convert from JSON to SharePermissionProject<PSCustomObject>
...
SharePermissionProject<PSCustomObject>
#>
function ConvertFrom-JsonToSharePermissionProject {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => SharePermissionProject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SharePermissionProject
