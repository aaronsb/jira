...
EventNotificationProjectRole<PSCustomObject>
#>

function Initialize-EventNotificationProjectRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => EventNotificationProjectRole' | Write-Debug
...
Convert from JSON to EventNotificationProjectRole<PSCustomObject>
...
EventNotificationProjectRole<PSCustomObject>
#>
function ConvertFrom-JsonToEventNotificationProjectRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => EventNotificationProjectRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EventNotificationProjectRole
