...
function ConvertFrom-JsonToJsonNode {
    ...
    Process {
        ...
        $AllProperties = ("elements", "array", "fields", "null", "floatingPointNumber", "numberValue", "numberType", "intValue", "longValue", "bigIntegerValue", "doubleValue", "decimalValue", "booleanValue", "binaryValue", "valueAsInt", "valueAsLong", "valueAsDouble", "valueAsBoolean", "valueNode", "containerNode", "missingNode", "object", "pojo", "number", "integralNumber", "int", "long", "double", "bigDecimal", "bigInteger", "textual", "boolean", "binary", "textValue", "valueAsText", "fieldNames")
