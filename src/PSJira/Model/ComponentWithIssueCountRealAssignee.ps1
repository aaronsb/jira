...
ComponentWithIssueCountRealAssignee<PSCustomObject>
#>

function Initialize-ComponentWithIssueCountRealAssignee {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => ComponentWithIssueCountRealAssignee' | Write-Debug
...
Convert from JSON to ComponentWithIssueCountRealAssignee<PSCustomObject>
...
ComponentWithIssueCountRealAssignee<PSCustomObject>
#>
function ConvertFrom-JsonToComponentWithIssueCountRealAssignee {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => ComponentWithIssueCountRealAssignee' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ComponentWithIssueCountRealAssignee
