...
IssueUpdateDetailsHistoryMetadata<PSCustomObject>
#>

function Initialize-IssueUpdateDetailsHistoryMetadata {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => IssueUpdateDetailsHistoryMetadata' | Write-Debug
...
Convert from JSON to IssueUpdateDetailsHistoryMetadata<PSCustomObject>
...
IssueUpdateDetailsHistoryMetadata<PSCustomObject>
#>
function ConvertFrom-JsonToIssueUpdateDetailsHistoryMetadata {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => IssueUpdateDetailsHistoryMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IssueUpdateDetailsHistoryMetadata
