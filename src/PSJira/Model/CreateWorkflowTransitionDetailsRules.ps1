...
CreateWorkflowTransitionDetailsRules<PSCustomObject>
#>

function Initialize-CreateWorkflowTransitionDetailsRules {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => CreateWorkflowTransitionDetailsRules' | Write-Debug
...
Convert from JSON to CreateWorkflowTransitionDetailsRules<PSCustomObject>
...
CreateWorkflowTransitionDetailsRules<PSCustomObject>
#>
function ConvertFrom-JsonToCreateWorkflowTransitionDetailsRules {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => CreateWorkflowTransitionDetailsRules' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateWorkflowTransitionDetailsRules
        $AllProperties = ("conditions", "validators", "postFunctions")
